...
knitr::include_graphics("imagem/agradecimentos.jpeg")
...
```{r gatas, figures-side, fig.show="hold", echo=FALSE, out.height="65%", out.width="75%", fig.align='center', fig.height=3, fig.cap=" "}

knitr::include_graphics("imagem/logos-lape-cigets.png")
...
---
# Base ICE
```{r ice, figures-side, fig.show="hold", echo=FALSE, out.height="100%", out.width="100%", fig.align='center', fig.height=3, fig.cap=" "}
...
```{r munic}
munic <- read.csv("https://raw.githubusercontent.com/danielppagotto/R_empreendedorismo1/main/politicas_empreendedorismo.csv",sep = ";", encoding = "UTF-8")
```
