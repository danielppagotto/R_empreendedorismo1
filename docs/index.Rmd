...
# O mais legal é que você pode armazenar essas consultas em novos objetos basta usar uma atribuição
...
```{r group_by, figures-side, fig.show="hold", echo=FALSE, out.height="90%", out.width="90%", fig.align='center', fig.height=3, fig.cap=" "}

knitr::include_graphics("imagem/group_by.png")
```

Fonte: [Datasciencemadesimple](https://www.datasciencemadesimple.com/group-by-function-in-r-using-dplyr/)
